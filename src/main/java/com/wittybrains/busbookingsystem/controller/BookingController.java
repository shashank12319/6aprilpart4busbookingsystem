...
public class BookingController {
	...
	public ResponseEntity<?> getBookingDetails(
	        @RequestParam(name = "busNumber", required = false) String busNumber,
	        @RequestParam(name = "username", required = false) String username,
	        @RequestParam(name = "source", required = false) String source,
	        @RequestParam(name = "destination", required = false) String destination,
	        @RequestParam(name = "driverName", required = false) String driverName) {

	    Booking bookingDetails = bookingService.getBookingDetails(busNumber, username, source, destination, driverName);

	    if (bookingDetails == null) {
	        // Return not found if no booking details found for the provided search criteria
